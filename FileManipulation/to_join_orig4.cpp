...
int main(){
	int click, impression, depth, position, index, desc_id_tokencnt, titid_tokencnt, purc_k_id_tokencnt, qid_tokencnt,query_id_freq, keyword_id_freq, title_id_freq, description_id_freq, user_id_freq, gender , age,ad_id_freq, adv_id_freq;
