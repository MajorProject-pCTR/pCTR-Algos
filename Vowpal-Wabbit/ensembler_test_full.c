...
int main(){
	...
	float ctr;
	FILE *fp1=fopen("pred_test_log.csv","r");
	FILE *fp2=fopen("pred_test_linear.csv","r");
	FILE *fp3=fopen("test_predictions_nn.txt", "r");
	FILE *fp4=fopen("test_final.txt","r");
	FILE *fp5=fopen("test.data.vw","w");
